...
<body class="bg-gray-50 min-h-screen flex flex-col">
  ...
  <main class="flex flex-col items-center justify-center w-full px-4 py-20">
    <div class="flex flex-col items-center justify-center mt-10 bg-white rounded-xl select-none shadow-[0_10px_20px_rgba(0,123,255,0.2)] w-full max-w-5xl p-10">

      <form action="#" method="post" class="flex flex-col items-center justify-center py-8 w-full space-y-8">
        ...
        <div class="flex justify-center space-x-6">
          <a href="/mypage"
            class="px-6 py-2 mt-10 bg-gray-400 text-white rounded-full shadow-lg transition-all hover:bg-gray-500 focus:outline-none">
            이전
          </a>
          <button type="button"
            onclick="goToDeletePage()"
            class="px-6 py-2 mt-10 bg-blue-500 text-white rounded-full shadow-lg transition-all hover:bg-blue-600 focus:outline-none">
            다음
          </button>
        </div>
