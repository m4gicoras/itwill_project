                            ...
                            <td class="flex items-center pt-4">
                                <c:choose>
                                    <c:when test="${order.status == 10}">
                                        <span class="translate-x-4 transform rounded-md bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-700">입고 준비중</span>
                                    </c:when>
                                    <c:when test="${order.status == 11}">
                                        <span class="translate-x-4 transform rounded-md bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700">입고 진행중</span>
                                    </c:when>
                                    <c:otherwise>
