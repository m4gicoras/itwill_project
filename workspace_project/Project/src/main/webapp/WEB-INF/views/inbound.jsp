                                        ...
                                        <a href="<%=request.getContextPath()%>/inbound" style="border-radius: 0px; width: 100%;">
                                            <div class="w-full items-center justify-center">
                                                <div class="flex w-full items-center justify-center">
                                                    ...
                                                    <p class="mr-auto text-sm font-semibold text-white">입고 현황</p>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
    ...
    <nav
        ...
        <div class="ml-[6px]">
            <p class="text-md shrink text-zinc-950 capitalize md:text-3xl"><a
                    class="font-bold capitalize hover:text-zinc-950" href="#" style="border-radius: 0px;">입고
                현황</a></p>
        </div>
            ...
            <div class="overflow-hidden rounded bg-white shadow">
                <table class="min-w-full text-gray-700">
                    ...
                    <tr>
                        ...
                        <th class="p-4 text-center">입고완료일시</th>
                        <th class="p-4 text-center">구매기업명</th>
                        <th class="p-4 text-center">상태</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach var="order" items="${inboundList}">
                        <tr class="border-b border-gray-300 hover:bg-gray-50">
                            ...
                            <td class="p-4 text-center">
                                <fmt:formatDate value="${order.inboundDate}" pattern="yyyy-MM-dd a hh:mm" />
                            </td>

                            <td class="p-4 text-center">${order.companyName}</td>
                            <td class="relative text-center group">
                                <c:choose>
                                    <c:when test="${order.status == 10}">
                                        <span class="inline-block rounded-md bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-700">입고 준비중</span>
                                    </c:when>

                                    <c:when test="${order.status == 11}">
                                        <!-- 입고 진행중 배지 -->
                                        <span class="inline-block rounded-md bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700 z-10 relative">
                                            입고 진행중</span>

                                        <!-- 수령 완료 버튼 (hover 시 등장) -->
                                        <form method="post" action="${pageContext.request.contextPath}/inbound/complete"
                                            ...
                                            <button type="submit"
                                                    onclick="return confirm('입고 완료 처리하시겠습니까?');"
                                    ...
                                    <c:when test="${order.status == 12}">
                                        <span class="inline-block rounded-md bg-green-100 px-2 py-1 text-xs font-medium text-green-700">입고 완료</span>
                                    </c:when>
