...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <!-- ✅ Main -->
    <main class="flex justify-center align-middle mt-5 px-8 py-20">
      <div class="flex flex-col gap-8 w-250">
            ...
            <table class="w-full">
              ...
              <thead>
                <tr class="border-b border-zinc-200 bg-gray-200"> <!-- 혹은 bg-zinc-200 -->
                  <th class="text-left px-8 py-3 font-semibold text-lg">프로필</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td class="px-8 py-5 flex items-center space-x-10">
                    ...
                    <div class="flex flex-col gap-2">
                      <p class="text-lg">김깜순</p>
                      <p class="text-zinc-500">dog@willbs.co.kr</p>
                    </div>
                  </td>
                </tr>
              </tbody>
            ...
            <table class="w-full">
              <thead>
                <tr class="border-b border-zinc-200 bg-gray-200">
                  <th colspan="2" class="text-left px-8 py-3 font-semibold text-lg">기본 정보</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">아이디</td>
                  <td>puppy12</td>
                </tr>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">닉네임</td>
                  <td>gae1</td>
                </tr>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">이메일</td>
                  <td class="italic text-zinc-600">dog@willbs.co.kr</td>
                </tr>
                <tr class="border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">연락처</td>
                  <td>010-1234-5667</td>
                </tr>
              </tbody>
            </table>
          ...
          <div class="w-full rounded-md overflow-hidden border-2 border-zinc-200">
            <table class="w-full">
              <thead>
                <tr class="border-b border-zinc-200 bg-gray-200">
                  <th colspan="2" class="text-left px-8 py-3 font-semibold text-lg">기업 정보</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">상호/법인명</td>
                  <td>삼성</td>
                </tr>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">대표자명</td>
                  <td>김삼성</td>
                </tr>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">사업자등록번호</td>
                  <td>135-16-15351</td>
                </tr>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">대표 전화</td>
                  <td>010-2366-1574</td>
                </tr>
                <tr class="border-b border-zinc-200 hover:bg-zinc-100/50">
                  <td class="px-8 py-3">주소</td>
                  <td>경기 성남시 분당구 판교역로 166 1층</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="w-full rounded-md overflow-hidden border-2 border-zinc-200">
            <table class="w-full">
              <thead>
                <tr class="border-b border-zinc-200 bg-gray-200">
                  <th class="text-left px-8 py-3 font-semibold text-lg">계정 연동</th>
                </tr>
              </thead>
              <tbody>
                <tr class="border-b border-zinc-200">
                  <td class="px-8 py-3 flex items-center justify-between space-x-4">
                    <div class="flex gap-5 items-center">
                      ...
                      <div class="text-zinc-700">dog@google.com</div>
                      <div class="text-xs text-zinc-500">연동일: <span>2015-03-11</span></div>
                    </div>
                ...
                <tr class="border-b border-zinc-200">
                  <td class="px-8 py-3 flex items-center justify-between space-x-4">
                    ...
                    <div class="flex-1 text-gray-500 text-sm">연결되지 않음</div>
                    <button type="button" class="bg-blue-500 text-white px-6 py-2 rounded-full shadow-lg hover:bg-blue-600 transition">
                      	연동
                    </button>
                  </td>
