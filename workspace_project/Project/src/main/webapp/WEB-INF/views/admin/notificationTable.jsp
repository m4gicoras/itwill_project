        ...
        <div class="mx-5 my-4 flex w-full flex-col gap-5 xl:mr-4 xl:ml-[332px]">
            ...
            <form action="${pageContext.request.contextPath}/admin/product" method="get">
                <div class="flex items-center justify-center gap-3 bg-blue-300/30 bg-search-bg rounded-lg py-3 px-4 w-full max-w-3xl mx-auto">
                    ...
                    <select id="searchOption" name="option" class="flex-1 border-none bg-white py-2.5 px-3.5 rounded-md focus:outline-none">
                        <option value="companyName">기업명</option>
                        <option value="content">내용</option>
                    </select>
                    <input type="text" id="companyInput" name="companyName" placeholder="기업명 입력" value="${companyName}" class="border-none bg-white py-2.5 px-3.5 rounded-md focus:outline-none" onkeydown="submitFormOnEnter(event)">
                    <input type="text" id="contentInput" name="content" placeholder="알림 내용 입력" value="${content}" class="border-none bg-white py-2.5 px-3.5 rounded-md focus:outline-none" onkeydown="submitFormOnEnter(event)">
