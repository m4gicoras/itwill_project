              ...
              <td class="p-4 text-center">
                <c:choose>
                  <c:when test="${noti.read}">
                    <span class="inline-block rounded-md px-2 py-1 text-xs font-medium bg-gray-200 text-gray-600">읽음</span>
                  </c:when>
                  <c:otherwise>
                    <span class="inline-block rounded-md px-2 py-1 text-xs font-medium bg-red-500 text-white">안읽음</span>
                  </c:otherwise>
                </c:choose>
              </td>
