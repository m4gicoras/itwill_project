    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <body style="font-family: 'Noto Sans KR', sans-serif;">
                    <div class="flex h-full w-full bg-white">
                                ...
                                <div style="position: relative; overflow: hidden; width: 100%; height: 100%;">
                                    <div class="!translate-x-[5.5%] pr-4 xl:!-mr-8 xl:w-[calc(100%_+_20px)]"
                                        ...
                                        <div class="flex h-full flex-col justify-between">
                                            <div>
                                                <span
                                                    class="absolute top-4 block cursor-pointer text-zinc-200 xl:hidden "><svg
                                                ...
                                                <div class="mt-8 flex items-center justify-center">
                                                    <h5
                                                        class="kimm-bold text-center text-4xl font-extrabold select-none">
                                                        Sellity
                                                    </h5>
                                                </div>
                                                ...
                                                <ul>
                                                            ...
                                                            <a href="<%=request.getContextPath()%>/dashboard"
                                                                ...
                                                                <div class="w-full items-center justify-center">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="svg-item text mt-1.5 mr-3 text-zinc-950">
                                                                        ...
                                                                        <p
                                                                            class="mr-auto text-sm font-medium text-zinc-950">
                                                                            상품 목록</p>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div
                                                        class="menu-item flex w-full max-w-full items-center justify-between rounded-lg py-3 pl-8 font-medium text-zinc-950 ">
                                                        <a class="undefined"
                                                            href="<%=request.getContextPath()%>/add_product"
                                                            style="border-radius: 0px; width: 100%;">
                                                            <div class="w-full items-center justify-center">
                                            ...
                                            <div class="mt-7 mb-9">
                                                ...
                                                <div
                                                    class="mt-5 flex w-full items-center rounded-lg border border-zinc-200 p-4 ">
                                                    ...
                                                    <form action="<%=request.getContextPath()%>/logout" method="post"
                                                        ...
                                                        <button
                                                            ...
                                                            <svg stroke="currentColor" fill="none" stroke-width="1.5"
                                                                ...
                                                                class="scale-60 h-10 w-10 stroke-2 text-zinc-950 " width="1em"
                                                                height="1em" color="inherit"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="color: inherit;">
                        ...
                        <nav
                            ...
                            <div class="ml-[6px]">
                                <p class="text-md shrink text-zinc-950 capitalize md:text-3xl"><a
                                        class="font-bold capitalize hover:text-zinc-950" href="#"
                                        style="border-radius: 0px;">알림</a></p>
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            <svg stroke="currentColor" fill="none" stroke-width="1.5"
                                                viewBox="0 0 24 24" aria-hidden="true"
                                                class="h-6 w-6 stroke-2 text-zinc-950 " height="1em" width="1em"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9">
                                                </path>
                        ...
                        <div class="mt-24 mr-4 mb-5 ml-4 flex w-full flex-col gap-5 xl:mr-4 xl:ml-[332px] xl:flex-row">
                            <div
                                class="bg-card text-card-foreground w-full rounded-lg border border-zinc-200 p-6 shadow-sm ">
                                <!-- 여기에 내용을 추가하세요 -->
                                    ...
                                    <table class="min-w-full text-gray-700">
                                        <thead class="border-b border-gray-300 bg-gray-200">
                                            <tr>
                                                ...
                                                <th class="p-4 text-center">내용</th>
                                                <th class="p-4 text-center">발송 일시</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <c:forEach var="noti" items="${notificationList}">
                                                <c:set var="formattedDate">
                                                    <fmt:formatDate value="${noti.createdAt}"
                                                        pattern="yyyy-MM-dd a hh:mm" />
                                                </c:set>
                                                <tr class="border-b hover:bg-gray-50 cursor-pointer"
                                                    data-id="${noti.notificationId}"
                                                    data-content="${fn:escapeXml(noti.content)}"
                                                    data-date="${formattedDate}" onclick="handleRowClick(this)">
                                                    <td class="p-4 text-center">
                                                        <c:choose>
                                                            <c:when test="${noti.read}">
                                                                <span
                                                                    class="inline-block rounded-md px-2 py-1 text-xs font-medium bg-gray-200 text-gray-600">읽음</span>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <span
                                                                    class="inline-block rounded-md px-2 py-1 text-xs font-medium bg-red-500 text-white">안읽음</span>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </td>
                ...
                <script src="<%= request.getContextPath() %>/resources/js/notification.js"></script>
