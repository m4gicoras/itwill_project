                ...
                <div>
                  <span class="absolute top-4 block cursor-pointer text-zinc-200 xl:hidden dark:text-white/40"
                    ><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></span>
                  ...
                  <ul>
                    <div>
                      <div class="flex w-full max-w-full items-center justify-between rounded-lg bg-zinc-950 py-3 pl-8 font-semibold text-white dark:bg-white dark:text-zinc-950">
                        <a class="undefined" href="/shadcn-nextjs-boilerplate/dashboard/main" style="border-radius: 0px; width: 100%;">
                          <div class="w-full items-center justify-center">
                            <div class="flex w-full items-center justify-center">
                              <div class="svg-item text mt-1.5 mr-3 font-semibold text-white dark:text-zinc-950">
                              ...
                              <p class="mr-auto text-sm font-semibold text-white dark:text-zinc-950">상품 목록</p>
                            </div>
                          </div>
                        </a>
                      </div>
                    ...
                    <div>
                      <div class="menu-item flex w-full max-w-full items-center justify-between rounded-lg py-3 pl-8 font-medium text-zinc-950 dark:text-zinc-400">
                        <a class="undefined" href="/shadcn-nextjs-boilerplate/dashboard/ai-chat" style="border-radius: 0px; width: 100%;">
                          <div class="w-full items-center justify-center">
                            <div class="flex w-full items-center justify-center">
                              ...
                              <p class="mr-auto text-sm font-medium text-zinc-950 dark:text-zinc-400">상품 등록</p>
                            </div>
                          </div>
                        </a>
                      </div>
                    ...
                    <div>
                      <div class="menu-item flex w-full max-w-full items-center justify-between rounded-lg py-3 pl-8 font-medium text-zinc-950 dark:text-zinc-400">
                        <a class="undefined" href="/shadcn-nextjs-boilerplate/dashboard/settings" style="border-radius: 0px; width: 100%;">
                          <div class="w-full items-center justify-center">
                            <div class="flex w-full items-center justify-center">
                              <div class="svg-item text mt-1.5 mr-3 text-zinc-950 dark:text-white">
                                <svg stroke="currentColor" fill="none" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true" class="-mt-[7px] h-4 w-4 stroke-2 text-inherit" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <p class="mr-auto text-sm font-medium text-zinc-950 dark:text-zinc-400">입고 현황</p>
                            </div>
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="menu-item flex w-full max-w-full items-center justify-between rounded-lg py-3 pl-8 font-medium">
                      <div class="w-full items-center justify-center">
                        <div class="flex w-full items-center justify-center">
                          ...
                          <p class="mr-auto text-sm font-medium text-zinc-950 dark:text-zinc-400">출고 현황</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="menu-item flex w-full max-w-full items-center justify-between rounded-lg py-3 pl-8 font-medium">
                      <div class="w-full items-center justify-center">
                        <div class="flex w-full items-center justify-center">
                          ...
                          <p class="mr-auto text-sm font-medium text-zinc-950 dark:text-zinc-400">견적 현황</p>
                        </div>
                      </div>
                    </div>
                    <div class="menu-item flex w-full max-w-full items-center justify-between rounded-lg py-3 pl-8 font-medium">
                      <div class="w-full items-center justify-center">
                        <div class="flex w-full items-center justify-center">
                          ...
                          <p class="mr-auto text-sm text-zinc-950 dark:text-white">정산 현황</p>
                        </div>
                      </div>
                    </div>
                  </ul>
