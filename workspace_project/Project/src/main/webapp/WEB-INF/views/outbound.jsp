                ...
                <table class="min-w-full text-gray-700">
                    ...
                    <c:forEach var="order" items="${outboundList}">
                        <tr class="border-b border-gray-300 hover:bg-gray-50">
                            ...
                            <td class="p-4 text-center">
                                <fmt:formatDate value="${order.shipCompDate}" pattern="yyyy-MM-dd a hh:mm" />
                            </td>
                            ...
                            <td class="flex items-center pt-4">
                                <c:choose>
                                    <c:when test="${order.status == 20}">
                                        <span class="translate-x-4 transform rounded-md bg-yellow-100 px-2 py-1 text-xs font-medium text-yellow-700">출고 준비중</span>
                                    </c:when>
                                    <c:when test="${order.status == 21}">
                                        <span class="translate-x-4 transform rounded-md bg-blue-100 px-2 py-1 text-xs font-medium text-blue-700">출고 진행중</span>
                                    </c:when>
                                    <c:otherwise>
                                        <span class="translate-x-4 transform rounded-md bg-gray-200 px-2 py-1 text-xs font-medium text-gray-600">상태 확인 필요</span>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
