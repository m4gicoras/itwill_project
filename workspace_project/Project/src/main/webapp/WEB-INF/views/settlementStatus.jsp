...
<html>
  ...
  <body style="font-family: 'Noto Sans KR', sans-serif;">
    ...
    <div class="flex h-full w-full bg-white select-none">
                      ...
                      <a href="<%=request.getContextPath()%>/settlementStatus" style="border-radius: 0px; width: 100%;">
                        <div class="w-full items-center justify-center">
                          <div class="flex w-full items-center justify-center">
                            ...
                            <p class="mr-auto text-sm font-semibold text-white">정산 현황</p>
                          </div>
                        </div>
                      </a>
                    </div>
                ...
                <div class="mt-7 mb-9">
                  ...
                  <div class="mt-5 flex w-full items-center rounded-lg border border-zinc-200 p-4">
                    <a href="/shadcn-nextjs-boilerplate/dashboard/dashboard/settings">
                      <span class="relative flex h-10 min-h-10 w-10 min-w-10 shrink-0 overflow-hidden rounded-full"> <img class="aspect-square h-full w-full" src="" /></span>
                    </a>
                    ...
                    <form action="<%=request.getContextPath()%>/logout" method="post" class="w-full">
                      <button class="ring-offset-background focus-visible:ring-ring bg-background hover:bg-accent hover:text-accent-foreground ml-auto flex h-[40px] w-[40px] cursor-pointer items-center justify-center rounded-full border border-zinc-200 p-0 text-center text-sm font-medium whitespace-nowrap transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50" type="submit">
                        <svg stroke="currentColor" fill="none" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 stroke-2 text-zinc-950" width="1em" height="1em" color="inherit" xmlns="http://www.w3.org/2000/svg" style="color: inherit;">
      ...
      <nav class="fixed top-3 right-3 z-[0] flex w-[calc(100vw_-_6%)] flex-row items-center justify-between rounded-lg bg-white/30 py-2 backdrop-blur-xl transition-all md:top-4 md:right-[30px] md:w-[calc(100vw_-_8%)] md:p-2 lg:w-[calc(100vw_-_6%)] xl:top-[20px] xl:w-[calc(100vw_-_365px)] 2xl:w-[calc(100vw_-_380px)]">
        ...
        <div class="ml-[6px]">
          <p class="text-md shrink text-zinc-950 capitalize md:text-3xl">
            <a class="font-bold capitalize hover:text-zinc-950" href="#" style="border-radius: 0px;">정산 현황</a>
          </p>
        </div>
        <!-- 상단바 오른쪽 파트 -->
        <div class="w-[154px] min-w-max md:ml-auto md:w-[unset]">
          <div class="relative flex max-w-max min-w-max flex-grow items-center justify-around gap-1 rounded-lg md:px-2 md:py-2 md:pl-3 xl:gap-2">
            <div class="flex items-center gap-2">
              <!-- 검색 박스 전용 래퍼 (크기 고정) -->
              <div class="relative h-[40px] w-[40px] flex-shrink-0">
                <!-- 검색 박스 컨테이너 (absolute) -->
                <div class="search-container absolute top-0 right-0">
                  <!-- 검색 아이콘 -->
                  <div class="search-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="fill-white" viewBox="0 0 24 24">
              ...
              <a href="<%=request.getContextPath()%>/notification/list" class="hover:bg-accent hover:text-accent-foreground relative flex h-10 w-10 px-2 items-center justify-center rounded-full border border-zinc-200 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6 w-6 stroke-2 text-zinc-950">
                ...
                <span class="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs leading-none font-bold text-white">3</span>
              </a>
              <button class="ring-offset-background focus-visible:ring-ring bg-background hover:bg-accent hover:text-accent-foreground flex h-9 min-w-9 cursor-pointer items-center justify-center rounded-full border border-zinc-200 p-0 text-xl font-medium whitespace-nowrap text-zinc-950 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 md:min-h-10 md:min-w-10">
                <svg stroke="currentColor" fill="none" stroke-width="1.5" viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 stroke-2 text-zinc-950" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m3 0 3-3m0 0-3-3m3 3H9"></path>
                </svg>
              </button>
      ...
      <!-- 메인 -->
      <div class="mt-24 mr-4 mb-5 ml-4 flex w-full flex-col gap-5 xl:mr-4 xl:ml-[332px]">
        <!-- 날짜 필터, 검색창 -->
        <div class="mr-4 flex items-center justify-end gap-2">
          <p>조회 날짜:</p>
          <input type="date" class="h-9 rounded-md border border-gray-300 px-2.5 py-1.5 text-sm focus:ring-2 focus:ring-blue-300 focus:outline-none" />
          <p>~</p>
          <input type="date" class="h-9 rounded-md border border-gray-300 px-2.5 py-1.5 text-sm focus:ring-2 focus:ring-blue-300 focus:outline-none" />
          <input type="text" class="h-9 rounded-md border border-gray-300 px-2.5 py-1.5 text-sm focus:ring-2 focus:ring-blue-300 focus:outline-none" />
        ...
        <div class="bg-card text-card-foreground w-full rounded-lg border border-zinc-200 p-6 shadow-sm">
          ...
          <div class="mb-3 flex gap-5">
            <div class="flex flex-1 items-center gap-6 rounded-md bg-green-600/7 p-2.5 pl-5">
              <svg class="h-6 w-6 text-green-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <table class="min-w-full text-gray-700">
              <thead class="border-b border-gray-300 bg-gray-200">
                <tr>
                  ...
                  <th class="p-4 text-center">물품명</th>
                  <th class="p-4 text-center">단가</th>
                  <th class="p-4 text-center">수량</th>
                  <th class="p-4 text-center">정산예정일</th>
                  <th class="p-4 text-center">정산완료일</th>
