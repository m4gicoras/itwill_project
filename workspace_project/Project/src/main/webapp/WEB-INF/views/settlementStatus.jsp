        ...
        <div class="w-[154px] min-w-max md:ml-auto md:w-[unset]">
          <div class="relative flex max-w-max min-w-max flex-grow items-center justify-around gap-1 rounded-lg md:px-2 md:py-2 md:pl-3 xl:gap-2">
            <div class="flex items-center gap-2">
              ...
              <a href="<%=request.getContextPath()%>/notification/list" class="hover:bg-accent hover:text-accent-foreground relative flex h-10 w-10 items-center justify-center rounded-full border border-zinc-200 transition-colors">
